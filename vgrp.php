		...
		<!-- /inner_content-->
				<div class="inner_content">
					...
					<div class="inner_content_w3_agile_info two_in">
					  <h2 class="w3_inner_tittle">Graphic Designs Listing</h2>
									<!-- tables -->
...
exit;}
    ...
    <p><b>Project Url</b>: <?php echo $row['graphic_url']; ?></p>
    <p><b>Tagline</b>: <?php echo $row['graphic_tagline']; ?></p>
    <p><b>Project File</b>: <?php echo $row['graphic_file']; ?></p>
    <p><b>Description</b>: <?php echo $row['graphic_desc']; ?></p>
