		...
		<!-- /inner_content-->
				<div class="inner_content">
					...
					<div class="inner_content_w3_agile_info two_in">
					  <h2 class="w3_inner_tittle">Template Listing Details</h2>
									<!-- tables -->
...
exit;}
    ...
    <p><b>Project Url</b>: <?php echo $row['template_url']; ?></p>
    <p><b>Tagline</b>: <?php echo $row['template_tagline']; ?></p>
    <p><b>Project File</b>: <?php echo $row['template_file']; ?></p>
    <p><b>Description</b>: <?php echo $row['template_desc']; ?></p>
