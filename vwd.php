...
exit;}
    ...
    <div><label><h2>Developer's Stage:</h2></label>
    <b><span><?php echo $row['dev_stage']; ?></span></b></div>

    <div><label><h2>Top Skills:</h2></label>
    <b><span><?php echo $row['dev_top_skills']; ?></span></b></div>

    <div><label><h2>Other Skills:</h2></label>
    <b><span><?php echo $row['dev_other_skills']; ?></span></b></div>

    <div><label><h2>Portfolios:</h2></label>
    <b><span> <?php echo $row['dev_portfolios']; ?></span></b></div>

    <div><label><h2>About Developer:</h2></label>
    <b><span><?php echo $row['about_dev']; ?></span></b></div>

     <div><label><h2>Language:</h2></label>
    <b><span><?php echo $row['dev_lang']; ?></span></b></div>

    <div><label><h2>Developer Document:</h2></label>
    <b><span><?php echo $row['dev_doc']; ?></span></b></div>

    <div><label><h2>Developer Rating:</h2></label>
    <b><span><?php echo $row['rating']; ?></span></b></div>
