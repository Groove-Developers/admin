...
$sql = "SELECT * FROM jobs ORDER BY id ASC LIMIT 30  ";
...
exit;}
   ...
   <tr>
    ...
    <ul class="dropdown-menu" role="menu">
      <li><?php echo '<a href="ejob.php?id='.$id.'">';?>Edit Project</a></li>
      <li><?php echo '<a href="vjob.php?id='.$id.'">';?>View Project</a></li>
      <li><?php echo '<a href="djob.php?id='.$id.'">';?>Delete Project</a></li>
    </ul>
  </div>
